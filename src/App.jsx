    ...
    <div className="min-h-screen text-white font-sans selection:bg-neonGreen selection:text-black bg-black">
      ...
      >
        ...
        <div className="hidden md:flex gap-6 text-sm font-semibold tracking-wider text-gray-300">
          <a href="#about" onClick={(e) => scrollToSection(e, 'about')} className="hover:text-neonGreen transition-colors cursor-pointer">ABOUT</a>
          ...
          <a href="#location" onClick={(e) => scrollToSection(e, 'location')} className="hover:text-neonGreen transition-colors cursor-pointer">UBICACIÓN</a>
        </div>
      </motion.nav>
      ...
      <motion.section
        ...
        className="py-20 px-6 max-w-3xl mx-auto relative z-10 text-center"
      >
      ...
      <section id="categories" className="py-20 px-6 max-w-5xl mx-auto relative z-10 flex flex-col items-center">
        ...
        <div className="w-full mb-16">
          ...
          >
            MINISUMO <span className="text-neonGreen">SENIOR</span>
          </motion.h3>
        ...
        <div className="w-full">
          ...
          >
            ...
            <img src="/images/img2.png" alt="Dragon Icon" className="w-10 h-10 object-contain drop-shadow-[0_0_8px_rgba(150,0,255,0.6)]" />
          </motion.div>
      ...
      <footer className="mt-20 border-t border-vibrantPurple/30 bg-black pt-16 pb-8 px-6 text-center relative z-10">
        <div className="max-w-4xl mx-auto flex flex-col items-center">
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="relative group overflow-hidden px-12 py-4 mb-20 bg-neonGreen/10 text-neonGreen font-road-rage text-3xl tracking-widest shadow-[0_0_20px_rgba(204,255,0,0.3)] hover:shadow-[0_0_40px_rgba(204,255,0,0.8)] border-2 border-neonGreen transition-all duration-300 backdrop-blur-sm"
          >
          ...
          <div className="flex justify-center flex-wrap items-center gap-12 opacity-80 mb-8 border-t border-gray-800 pt-8 w-full">
            ...
            <div className="flex flex-col items-center group cursor-pointer">
              <img src="/images/img2.png" alt="Dragon Icon" className="w-20 h-auto object-contain transition-opacity duration-300 grayscale hover:grayscale-0 hover:brightness-125 saturate-200" style={{ filter: 'drop-shadow(0px 0px 5px rgba(255,255,255,0.2)) grayscale(100%) brightness(150%)' }} />
            </div>
            <div className="flex flex-col items-center group cursor-pointer">
