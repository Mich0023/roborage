        ...
        <div className="min-h-screen text-white font-sans selection:bg-neonGreen selection:text-black bg-black">
            ...
            <section className="py-20 px-6 w-full relative z-10 flex flex-col items-center bg-neonGreen text-black transform -skew-y-2 my-10 border-y-4 border-vibrantPurple">
                <div className="transform skew-y-2 w-full max-w-4xl mx-auto text-center flex flex-col items-center">
                    ...
                    <div className="mt-8 bg-black px-8 py-3 rounded-sm border-2 border-black inline-block">
                        <span className="text-neonGreen font-mono font-bold text-xl md:text-2xl tracking-widest">MUY PRONTO...</span>
                    </div>
                </div>
            </section>
            ...
            <section className="py-16 px-6 text-center relative z-10">
                <h2 className="text-2xl font-road-rage text-neonGreen mb-10 tracking-widest">Síguenos</h2>
                <div className="flex justify-center items-center gap-10 text-white">
                    <a href="#" target="_blank" rel="noreferrer" className="hover:text-neonGreen transition-colors hover:scale-110 transform duration-300" aria-label="Facebook">
                        <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 24 24" fill="currentColor" stroke="none"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
                    </a>
                    <a href="#" target="_blank" rel="noreferrer" className="hover:text-neonGreen transition-colors hover:scale-110 transform duration-300" aria-label="YouTube">
                        <svg xmlns="http://www.w3.org/2000/svg" width="70" height="50" viewBox="0 0 24 24" fill="currentColor" stroke="none"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.5 12 3.5 12 3.5s-7.505 0-9.377.55a3.016 3.016 0 0 0-2.122 2.136C0 8.087 0 12 0 12s0 3.913.501 5.814a3.016 3.016 0 0 0 2.122 2.136c1.872.55 9.377.55 9.377.55s7.505 0 9.377-.55a3.016 3.016 0 0 0 2.122-2.136C24 15.913 24 12 24 12s0-3.913-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" /></svg>
                    </a>
                    <a href="#" target="_blank" rel="noreferrer" className="hover:text-neonGreen transition-colors hover:scale-110 transform duration-300" aria-label="Instagram">
